...
class Game:
    def _init__(self, run_name):
        ...
        while True:
            ...
            if answer == "y" or answer == "Y":
                ...
                while True:
                    ...
                    flag , img = cv2.VideoCapture(camera_location).read()
        ...
        while True:
            ...
            answer = str(input())
            ret , img = cv2.VideoCapture(camera_location).read()
...
while 1:
    ...
    if board.turn == False and board.is_checkmate() == False:
        ...
        ret , img_1 = cv2.VideoCapture(camera_location).read()
        ...
        ret , img_2 = cv2.VideoCapture(camera_location).read()
